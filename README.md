...
### The program is compatible with Windows10 and Windows11 versions on 32bit and 64bit architecture.
### In case of problems, you can contact the developer(eugeneviktorov).

### You can view the user manual on the website for downloading the program.
